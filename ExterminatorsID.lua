ExterminatorsID = menu.add_submenu("Ultimate Menu ExterminatorsID V18")

local function Text(text)
	ExterminatorsID:add_action(text,  function() end)
end

Text("=============================")
Text("           External Script Buatan Jawir")
Text("                   ExterminatorsID")
Text("=============================")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Self = ExterminatorsID:add_submenu("👨 Self")
...
GodMode = false
	Self:add_toggle("God Mode", function()
		GodMode = localplayer:get_godmode()
		return GodMode
	end, function()
		GodMode = not GodMode
		localplayer:set_godmode(GodMode)
	end)
...
Self:add_action("Clear Wanted Level", function() localplayer:set_wanted_level(0) end)
 ...
 Caps:add_action("jangan di pencet", function() localplayer:set_wanted_level(7) end)
...
local ExterminatorsIDPL = nil
local was_opened = true
 
local function BuildListSub() -- Deprecated for the moment
	ExterminatorsIDPL:add_bare_item("---Player List, "..GetPlayerCount().." Players---", function() was_opened = true return "---ExterminatorsID's Player List, "..GetPlayerCount().." Players---" end, null, null, null)
 
	local popt = {}
	for i = 0, 31 do
		local ply = player.get_player_ped(i)
		if ply then 
			popt[i] = ExterminatorsIDPL:add_submenu(f_p_o(i, ply, player.get_player_name(i))) -- add_player_option(ExterminatorsIDPL, i, ply, player.get_player_name(i))
...
local function BuildList()
	ExterminatorsIDPL:add_bare_item("---Player List, "..GetPlayerCount().." Players---", function() was_opened = true return "---Player List, "..GetPlayerCount().." Players---" end, null, null, null)
 
	for i = 0, 31 do
		local ply = player.get_player_ped(i)
		if ply then 
			add_player_option(ExterminatorsIDPL, i, ply, player.get_player_name(i))
		end
	end
 
	Text(ExterminatorsIDPL, "---End---")
 
	local subtp = ExterminatorsIDPL:add_submenu("Teleport Options")
	local subtroll = ExterminatorsIDPL:add_submenu("Trolling Options")
	local subinfo = ExterminatorsIDPL:add_submenu("Player Info")
...
ExterminatorsIDPL = ExterminatorsID:add_submenu("🌎 Online Players", Update)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDWEAPON = ExterminatorsID:add_submenu("🔫 Weapons")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

VehiclesM= ExterminatorsID:add_submenu("🚗 Vehicle")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

RMenu = ExterminatorsID:add_submenu("❤️‍ Recovery")
...
ExterminatorsIDMONEYREMOVER = ExterminatorsID:add_submenu("✂️ Money Remover Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDMONEYREMOVER:add_int_range("Set Ballastic Value", 1000000, 1000000, 2000000000, function() 
...
ExterminatorsID7 = ExterminatorsID:add_submenu("🏦 Ultimate Money Methods Menu")
...
ExterminatorsIDWEAPON:add_action("Full Ammo ", function() menu.max_all_ammo() end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDWEAPON1 = ExterminatorsIDWEAPON:add_submenu("Weapone Data Editor")
...
local function increaseBulletDamageWhenShooting()
	...
	if bullet < 999999999 then
	weapon_data[weapon:get_name_hash()] = force
          weapon:set_bullet_damage(999999999)
	end
end
...
ExterminatorsIDWEAPON1:add_toggle("Enable 1 Hit Bullet", function() return enabled end, supraABullet)
...
ExterminatorsIDT = ExterminatorsID:add_submenu("😺 Teleports")

ExterminatorsIDT:add_action("Teleport To WayPoint", function() menu.teleport_to_waypoint() end)
ExterminatorsIDT:add_action("Teleport To Objective", function() menu.teleport_to_objective() end)
ExterminatorsIDT:add_action("Teleport  Forward", function() menu.teleport_forward() end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

TunMenu = ExterminatorsID:add_submenu("🏁 Tunables")
...
ExterminatorsIDWORLD = ExterminatorsID:add_submenu("🙎 World")

ExterminatorsIDNPC = ExterminatorsIDWORLD:add_submenu("Npcs Menu")


ExterminatorsIDNPC:add_action("Kill All Npcs", function() menu.kill_all_npcs() end)
ExterminatorsIDNPC:add_action("Kill Mission Npcs", function() menu.kill_all_mission_peds() end) 

local FreezeNPCS = ExterminatorsIDNPC:add_submenu("Freeze All Npcs Menu")
...
funcmenu = ExterminatorsIDWORLD:add_submenu("Cars Menu")
...
ExterminatorsIDWORLD:add_action(
    'End Cutscene',
    function()
        menu.end_cutscene()
    end
...
ExterminatorsIDREPORTS = ExterminatorsID:add_submenu("🎉 Delete Reports Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDREPORTS:add_action("Active Delete Reports", function()
...
ExterminatorsIDREPORTSVIEWMENU = ExterminatorsID:add_submenu("📢 View Reports Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Griefing:".. (string.format("%03d", stats.get_int("MPPLY_GRIEFING"))) end, function() end, function()end, function() return end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Exploits:".. (string.format("%03d", stats.get_int("MPPLY_EXPLOITS"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Bug Exploits:".. (string.format("%03d", stats.get_int("MPPLY_GAME_EXPLOITS"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Text Chat:Annoying Me:".. (string.format("%03d", stats.get_int("MPPLY_TC_ANNOYINGME"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Text Chat:Using Hate Speech:".. (string.format("%03d", stats.get_int("MPPLY_TC_HATE"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Voice Chat:Annoying Me:".. (string.format("%03d", stats.get_int("MPPLY_VC_ANNOYINGME"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Voice Chat:Using Hate Speech:".. (string.format("%03d", stats.get_int("MPPLY_VC_HATE"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Offensive Language:".. (string.format("%03d", stats.get_int("MPPLY_OFFENSIVE_LANGUAGE"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Offensive Tagplate:".. (string.format("%03d", stats.get_int("MPPLY_OFFENSIVE_TAGPLATE"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Offensive Content:".. (string.format("%03d", stats.get_int("MPPLY_OFFENSIVE_UGC"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Bad Crew Name:".. (string.format("%03d", stats.get_int("MPPLY_BAD_CREW_NAME"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Bad Crew Motto:".. (string.format("%03d", stats.get_int("MPPLY_BAD_CREW_MOTTO"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Bad Crew Status:".. (string.format("%03d", stats.get_int("MPPLY_BAD_CREW_STATUS"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Bad Crew Emblem:".. (string.format("%03d", stats.get_int("MPPLY_BAD_CREW_EMBLEM"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Friendly:".. (string.format("%03d", stats.get_int("MPPLY_FRIENDLY"))) end, function() end, function()end, function()end)
ExterminatorsIDREPORTSVIEWMENU:add_bare_item("", function() return "Helpful:".. (string.format("%03d", stats.get_int("MPPLY_HELPFUL"))) end, function() end, function()end, function()end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDH = ExterminatorsID:add_submenu("🖕 Heists Data Editor")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDCONTRACTS = ExterminatorsID:add_submenu("💼 Contracts Data Editor")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 ExterminatorsID014 = ExterminatorsIDCONTRACTS:add_submenu("The Contract Menu")

 ExterminatorsID014:add_action("Set Up Dre Finale Mission", function()
	 PlayerIndex = globals.get_int(1574918)
	 if PlayerIndex == 0 then
 ...
 ExterminatorsID014:add_int_range("Payout", 100000, 0, 2500000, function()
...
ExterminatorsID1:add_action("__________________________________", function() end)
local function Text(text)
	ExterminatorsID1:add_action(text, function() end)
end

ExterminatorsID1:add_action("Get Money ( 1 Million - (( Heist Auto Shop )) ", function() end)
local function Text(text)
	ExterminatorsID1:add_action(text, function() end)
end

ExterminatorsID1:add_action(" Get  All 1 Min $ ", function() for i = 293174, 293182 do globals.set_int(i, 1000000) end globals.set_float(293171,0) end) 
...
AutoShop_heist_passed_value = 43655
 ...
 ExterminatorsID3 = ExterminatorsID0:add_submenu("Instant Heist Passed")

ExterminatorsID3:add_action("Instant Heist Passed", function()
 ...
 ExterminatorsID3:add_action("(Wait 5 secs to use after loading)", function() end)


ExterminatorsID388 = ExterminatorsID0:add_submenu("Missions Tools")
...
ExterminatorsID388:add_action("---------------Contracts Stats Editor-----------------", function() end) 
ExterminatorsID388:add_int_range("Contracts Done", 1, 0, 9999, function()
 return stats.get_int(MPX.."TUNER_COUNT") end, function(v)
 stats.set_int(MPX.."TUNER_COUNT", v) end) 
ExterminatorsID388:add_int_range("Contracts Earnings", 500000, 0, 1000000000, function()
 return stats.get_int(MPX.."TUNER_EARNINGS") end, function(v)
 stats.set_int(MPX.."TUNER_EARNINGS", v) end) 

ExterminatorsID388:add_action("-----", function() end) 


--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDAPARTMENT = ExterminatorsIDH:add_submenu("Apartment Data Editor")

ExterminatorsIDAPARTMENT:add_action("Skip Current Apartment Heist Preps", function() stats.set_int(MPX .. "HEIST_PLANNING_STAGE", -1) end) 


ExterminatorsIDAPCUT = ExterminatorsIDAPARTMENT:add_submenu("Apartmen Cuts Editor")


ExterminatorsIDAPCUT:add_int_range("Apt Player 1", 1.0, 15, 100, function() return globals.get_int(1940667) end, function(value) globals.set_int(1940667, value) end) 
ExterminatorsIDAPCUT:add_int_range("Apt Player 2", 1.0, 15, 100, function() return globals.get_int(1940668) end, function(value) globals.set_int(1940668, value) end) 
ExterminatorsIDAPCUT:add_int_range("Apt Player 3", 1.0, 15, 100, function() return globals.get_int(1940669) end, function(value) globals.set_int(1940669, value) end) 
ExterminatorsIDAPCUT:add_int_range("Apt Player 4", 1.0, 15, 100, function() return globals.get_int(1940670) end, function(value) globals.set_int(1940670, value) end) 


ExterminatorsIDAPCUT:add_action("All 200", function() for i = 1940667, 1940670 do globals.set_int(i, 200) end end)

ExterminatorsIDAPCUT:add_action("All 179", function() for i = 1940667, 1940670 do globals.set_int(i, 179) end end)
ExterminatorsIDAPCUT:add_action("All 150", function() for i = 1940667, 1940670 do globals.set_int(i, 150) end end)
ExterminatorsIDAPCUT:add_action("All 120", function() for i = 1940667, 1940670 do globals.set_int(i, 120) end end)
ExterminatorsIDAPCUT:add_action("All 100", function() for i = 1940667, 1940670 do globals.set_int(i, 100) end end)

ExterminatorsIDAPCUT:add_action("All 85", function() for i = 1940667, 1940670 do globals.set_int(i, 85) end end)
ExterminatorsIDAPCUT:add_action("All 75", function() for i = 1940667, 1940670 do globals.set_int(i, 75) end end)
ExterminatorsIDAPCUT:add_action("All 50", function() for i = 1940667, 1940670 do globals.set_int(i, 50) end end)
ExterminatorsIDAPCUT:add_action("All 25", function() for i = 1940667, 1940670 do globals.set_int(i, 25) end end)
ExterminatorsIDAPCUT:add_action("All 0", function() for i = 1940667, 1940670 do globals.set_int(i, 0) end end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDCASINO = ExterminatorsIDH:add_submenu("Casino Data Editor")


local ExterminatorsIDCASINO = ExterminatorsIDCASINO:add_submenu("Casino Editor Section")
PlayerIndex = globals.get_int(1574918)
...
local function Text(text)
	ExterminatorsIDCASINO:add_action(text, function() end)
end
Text(" _______________Casino Setup________________")
 
ExterminatorsIDCASINO:add_int_range("Target - Cash1/Gold2/Art3/Diam4", 1, 1, 4, function() return stats.get_int(MPX .. "H3OPT_TARGET") end, function(TGT)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("Random Approach - Normal/Hard", 1, 1, 2, function() return 1 end, function(H3lvl)
...
ExterminatorsIDCASINO:add_int_range("EasyApproach - Snk/BgCon/Aggr", 1, 1, 3, function() return 1 end, function(Approach)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("HardApproach - Snk/BgCon/Aggr", 1, 1, 3, function() return stats.get_int(MPX .. "H3_HARD_APPROACH") end, function(Approach)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_action("             ---[[Complete Board1]]---", function()
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("Hacker - Rickie 3%/Avi 10%/Paige 9%", 1, 1, 3, function() return stats.get_int(MPX .. "H3OPT_CREWHACKER") end, function(Hkr)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("Grlla/Clwn/Anml9/Riot/OniF/Hockey", 1, 1, 12, function() return stats.get_int(MPX .. "H3OPT_MASKS") end, function(H3Msk)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("Weap-Karl/Gus/Char/Ches/Pat", 1, 1, 5, function() return stats.get_int(MPX .. "H3OPT_CREWWEAP") end, function(H3Weap)
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_action("       ---[[Complete Board2 - Finale]]---", function()
	PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsIDCASINO:add_int_range("Casino Player1 Cut", 5.0, 15, 100, function() 
...
ExterminatorsIDCASINO:add_int_range("Casino Player2 Cut", 5.0, 15, 100, function() 
...
ExterminatorsIDCASINO:add_int_range("Casino Player3 Cut", 5.0, 15, 100, function() 
...
ExterminatorsIDCASINO:add_int_range("Casino Player4 Cut", 5.0, 15, 100, function() 
...
ExterminatorsIDCASINO:add_int_range("Casino Lifes - Self", 1, 1, 999999999, function() return fmC:get_int(26133 + 1325 + 1) end, function(life) if fmC and fmC:is_active() then fmC:set_int(26133 + 1325 + 1,life) end end)


local STRKM52=52962;
ExterminatorsIDCASINO:add_action("Crack Casino Fingerprint", function()
...
local STRKM51=54024;
ExterminatorsIDCASINO:add_action("Crack Casino Keypads", function()
	local heist_script = script("fm_mission_controller")
	if heist_script and heist_script:is_active() then
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 ExterminatorsIDCAYO = ExterminatorsIDH:add_submenu("Cayo Perlco Heist")
 
ExterminatorsIDCAYO:add_array_item("Presets", {"H.Panther Only", "H.PinkD Only", "H.B.Bonds Only", "H.R.Necklace Only", "H.Tequila Only", "N.Panther Only", "N.PinkD Only", "N.B.Bonds Only", "N.R.Necklace Only", "N.Tequila Only"}, function()
...
ExterminatorsIDCAYO:add_array_item("Primary Target", {"Tequila", "Ruby Necklace", "Bearer Bonds", "Pink Diamond", "Panther Statue"}, function()
 return
...
StMenu = ExterminatorsIDCAYO:add_submenu("Secondary Targets") 
...
ExterminatorsIDCAYO:add_array_item("Weapons", {"Aggressor", "Conspirator", "Crackshot", "Saboteur", "Marksman"}, function()
...
ExterminatorsIDCAYO:add_array_item("Approach Vehicles", {"Kosatka", "Alkonost", "Velum", "Stealth Annihilator", "Patrol Boat", "Longfin", "All Vehicles"}, function() return xox_4 end, function(value) if value == 1 then stats.set_int(MPX .. "H4_MISSIONS", 65283) elseif value == 2 then stats.set_int(MPX .. "H4_MISSIONS", 65413) elseif value == 3 then stats.set_int(MPX .. "H4_MISSIONS", 65289) elseif value == 4 then stats.set_int(MPX .. "H4_MISSIONS", 65425) elseif value == 5 then stats.set_int(MPX .. "H4_MISSIONS", 65313) elseif value == 6 then stats.set_int(MPX .. "H4_MISSIONS", 65345) elseif value == 7 then stats.set_int(MPX .. "H4_MISSIONS", 65535) end xox_4 = value end)	
ExterminatorsIDCAYO:add_array_item("Difficulty", {"Normal", "Hard"}, function() return xox_5 end, function(value) if value == 1 then stats.set_int(MPX .. "H4_PROGRESS", 126823) elseif value == 2 then stats.set_int(MPX .. "H4_PROGRESS", 131055) end xox_5 = value end)
ExterminatorsIDCAYO:add_action("       ---> Complete Preps - Finale <---", function() stats.set_int(MPX .. "H4CNF_UNIFORM", -1) stats.set_int(MPX .. "H4CNF_GRAPPEL", -1) stats.set_int(MPX .. "H4CNF_TROJAN", 5) stats.set_int(MPX .. "H4CNF_WEP_DISRP", 3) stats.set_int(MPX .. "H4CNF_ARM_DISRP", 3) stats.set_int(MPX .. "H4CNF_HEL_DISRP", 3) end)
ExterminatorsIDCAYO:add_action("All POI", function() stats.set_int(MPX .. "H4CNF_BS_GEN", -1) stats.set_int(MPX .. "H4CNF_BS_ENTR", 63) stats.set_int(MPX .. "H4CNF_APPROACH", -1) end) ExterminatorsIDCAYO:add_action("---", function() end)
ExterminatorsIDCAYO:add_action("Instant Finish $$", function() fmC2020:set_int(42280, 51338752) fmC2020:set_int(43655, 50) end) --Local_42279.f_1375[1] & Local_42279.f_1

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDCAYO1911 =  ExterminatorsIDCAYO :add_submenu("Skip Cayo Perico Cooldown Menu")

ExterminatorsIDCAYO1911:add_action("Skip Cayo Cooldown (Friends Mode)", function()
 ...
 ExterminatorsIDCAYO1911:add_action("Skip Cayo Cooldown (Solo Mode)", function()
	 mpIndex = globals.get_int(1574918)
	 if mpIndex == 0 then
...
ExterminatorsIDCAYO:add_action("(Wait 5 secs to use after cutscene)", function() end)ExterminatorsIDCAYO:add_action("---", function() end) local function npcC(e) if not localplayer then return end if e then globals.set_float(RPN1, 0) globals.set_float(RPN2, 0) else globals.set_float(RPN1, -0.1) globals.set_float(RPN2, -0.02) end end ExterminatorsIDCAYO:add_toggle("Remove Pavel n Fencing Cut", function() return e28 end, function() e28 = not e28 npcC(e28) end) local function Cctv(e) if not localplayer then return end if e then menu.remove_cctvs() else menu.remove_cctvs(nil) end end
ExterminatorsIDCAYO:add_toggle("Remove CCTV", function() return e6 end, function() e6 = not e6 Cctv(e6) end) ExterminatorsIDCAYO:add_action("Skip Drainage cut", function() if fmC2020:is_active() then if fmC2020:get_int(26746) >= 3 or fmC2020:get_int(26746) <= 6 then fmC2020:set_int(26746, 6) end end end) ExterminatorsIDCAYO:add_action("Bypass Fingerprint Cloner ", function() if fmC2020 and fmC2020:is_active() then if fmC2020:get_int(22032) == 4 then fmC2020:set_int(22032, 5) end end end)
ExterminatorsIDCAYO:add_action("Quick Plasma Cutter", function() fmC2020:set_float(27985 + 3, 99.9) end) ExterminatorsIDCAYO:add_int_range("Cayo Lifes - Self", 1.0, 1, 999999999, function() return fmC2020:get_int(48647 + 865 + 1) end, function(life) if fmC2020 and fmC2020:is_active() then fmC2020:set_int(48647 + 865 + 1, life) end end) ExterminatorsIDCAYO:add_action("Kill mission npcs", function() menu.kill_all_mission_peds() end) ExterminatorsIDCAYO:add_action("Kill all npcs", function() menu.kill_all_npcs() end) ExterminatorsIDCAYO:add_action("---", function() end)
ExterminatorsIDCAYO:add_int_range("Real Take", 289700, 100000, 8691000, function() return fmC2020:get_int(45687+1392+53) end, function(v) fmC2020:set_int(45687+1392+53, v) end)
ExterminatorsIDCAYO:add_array_item("TP's Scope Out", {"Communications Tower", "Control Tower", "Power Station", "Bolt Cutters #1", "Bolt Cutters #2", "Bolt Cutters #3", "Bolt Cutters #4", "Bolt Cutters #5", "Bolt Cutters #6", "Bolt Cutters #7", "Bolt Cutters #8", "Bolt Cutters #9", "Bolt Cutters #10", "Bolt Cutters #11", "Bolt Cutters #12", "Bolt Cutters #13", "Bolt Cutters #14", "Bolt Cutters #15", "Cutting Powder #1", "Cutting Powder #2", "Cutting Powder #3", "Grappling Hook #1", "Grappling Hook #2", "Grappling Hook #3", "Grappling Hook #4", "Grappling Hook #5", "Grappling Hook #6", "Grappling Hook #7", "Grappling Hook #8", "Grappling Hook #9", "Grappling Hook #10", "Guard Clothes #1", "Guard Clothes #2", "Guard Clothes #3", "Guard Clothes #4", "Guard Clothes #5", "Guard Clothes #6", "Guard Clothes #7", "Signal Box #1", "Signal Box #2", "Signal Box #3", "Supply Truck #1", "Supply Truck #2", "Supply Truck #3", "Supply Truck #4", "Water Tower #1 (North Dock)", "Water Tower #2 (Main Dock)"}, function()
...
ExterminatorsIDCAYO:add_array_item("TP's Heist", {"Drainage Pipe", "Entry Drain", "Cayo Office", "Cayo Primary", "Basement Storage", "North Storage", "West Storage", "South Storage", "Cayo Gate", "Escaped"}, function() return xox_7 end, function(value)
...
ExterminatorsIDDOOMSDAY:add_action("Complete All", function()
 stats.set_int(MPX.."GANGOPS_FM_MISSION_PROG", -1) end) 
ExterminatorsIDDOOMSDAY:add_action("Reset Heist", function()
 stats.set_int(MPX.."GANGOPS_FLOW_MISSION_PROG", 240)
 stats.set_int(MPX.."GANGOPS_HEIST_STATUS", 0)
 stats.set_int(MPX.."GANGOPS_FLOW_NOTIFICATIONS", 1557)
 end) 

ExterminatorsIDDOOMSDAY:add_action("-----", function()
 end) 

ExterminatorsIDDOOMSDAY:add_action("Instant Finish $$", function()
...
ExterminatorsIDDOOMSDAY:add_action("(Wait 5 secs  to use after loading, press", function()
 end) 

ExterminatorsIDDOOMSDAY:add_action("again 5 secs after loading inside building)", function()
 end) 

ExterminatorsIDDOOMSDAY:add_action("-----", function()
 end) 

ExterminatorsIDDOOMSDAY:add_action("Bypass Act III Hack", function()
 fmC:set_int(1400, 3)
 end) 

ExterminatorsIDDOOMSDAY:add_action("Kill mission npcs", function()
 menu.kill_all_mission_peds()
 end) 

ExterminatorsIDDOOMSDAY:add_action("Kill all npcs", function()
 menu.kill_all_npcs()
 end)

ddCMenu = ExterminatorsIDDOOMSDAY:add_submenu("Cuts")
...
CasinoT = ExterminatorsIDT:add_submenu("Teleport The Casino ")  
...
CayoT = ExterminatorsIDT:add_submenu("Teleport The Cayo Perlco ")  
...
Teleports1 = ExterminatorsIDT:add_submenu("Criminal Enterprises Location")
...
Teleports2 = ExterminatorsIDT:add_submenu("Location M14")
...
DLC164 = ExterminatorsIDT:add_submenu("Location Gun Van")
...
ExterminatorsID3 = ExterminatorsID:add_submenu("🔒 Weapon Unlocker Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsID3:add_action("Unlock Gun Van RailGun", function()
...
ExterminatorsID3:add_toggle("Enable Deleted Vehicles", function() return globals.get_int(262145+35167) end, function(value) local startNum = 35167 local endNum = 20394 for i = startNum, endNum, 2 do globals.set_int(262145 + i, 1) end end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDEVENTS = ExterminatorsID:add_submenu("🎟️ Events Menu")
...
---Facilities Unlocks Section---
	...
	LSCMenu = FUMenu:add_submenu("LS Customs")
         ...
         ExterminatorsIDWepMenu = FUMenu:add_submenu("Unlock Guns Menu")
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
     ...
     ExterminatorsID6 = Self:add_submenu("LSCM Unlocker Menu")
...
ExterminatorsIDNOCLP = Self:add_submenu("NoClip Menu")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDNOCLP:add_toggle("NoClip", function()
 return enable end, function()
 enable = not enable NoClip(enable) end)
 ExterminatorsIDNOCLP:add_int_range("NoClip Speed", 1, 1, 100, function()
...
--© 2023 ExterminatorsID's Official Discord Server. All Rights Reserved--

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsID5 = ExterminatorsID:add_submenu("💪 Missions Selector & cooldown")
...
ExterminatorsID5:add_array_item("Auto Shop Heist Select>", { "Unselected", "Union Depository", "Superdollar Deal", "Bank Contract", "ECU Job", "Prison Contract", "Agency Deal", "LOST Contract", "Data Contract" },
...
ExterminatorsID5:add_array_item("ULP Contract Select>", { "Intelligece", "Counterintelligence", "Extraction", "Asset Seizure", "Operation Paper Trail", "CleanUp" }, function()
...
local ExterminatorsIDDRGWR={"Designated Driver[2]","FatalIncursion[3]","Uncontrolled Substance[4]","Make War not Love[5]","Off the Rails[6]","This is an Intervention[7]","Unusual Suspects[8]","FriedMind[9]","Checking In[10]","BDKD[11]"}
ExterminatorsIDDRGWR[0]="Welcome to the Troupe[1]"
ExterminatorsID5:add_array_item("Dose Missions>", ExterminatorsIDDRGWR, function() return stats.get_int(mpx() .. "XM22_CURRENT") end, function(v)
...
ExterminatorsID7:add_toggle("Start Ceo Manager",
  function()
...
ExterminatorsID9 = ExterminatorsID7:add_submenu("Ultimate Money Manager Settings")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsIDML = ExterminatorsID7:add_submenu("Nighclub Money Loop 250k/10s")
...
ExterminatorsIDWepMenu:add_action("Unlock Double Action Revolver",function()
...
ExterminatorsIDWepMenu:add_action("Unlock Stone Hatchet",function()
...
ExterminatorsIDWepMenu:add_action("Unlock Guns And Skins", function()
	stats.set_int(MPX .. "CHAR_WEAP_UNLOCKED", -1)
	stats.set_int(MPX .. "CHAR_WEAP_UNLOCKED2", -1)
	stats.set_int(MPX .. "CHAR_WEAP_UNLOCKED3", -1)
	stats.set_int(MPX .. "CHAR_WEAP_UNLOCKED4", -1)
...
ExterminatorsIDSNOW = ExterminatorsIDEVENTS:add_submenu("Snow Toggle Menu")
...
ExterminatorsIDSNOW:add_toggle("Toggle Snow", function()
    return globals.get_boolean(snowAddress)
end, toggleSnow)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsID6:add_action("LSCM Prize Ride Unlock", function() stats.set_bool(MPX .. "CARMEET_PV_CHLLGE_CMPLT", true) end)

ExterminatorsID5:add_action("Remove Dax Missions CoolDown ", function()
	function MPX()return stats.get_int("MPPLY_LAST_MP_CHAR")end 
	        stats.set_int("MP"..MPX().."_XM22JUGGALOWORKCDTIMER", -1) 
end)

ExterminatorsID5:add_action("Remove VIP/MC Cool Down", function() stats.set_int("MPPLY_VIPGAMEPLAYDISABLEDTIMER", 0) end)

ExterminatorsID5:add_action("Skip Lamar Mision", function() stats.set_bool(MPX .. "LOW_FLOW_CS_DRV_SEEN", true) stats.set_bool(MPX .. "LOW_FLOW_CS_TRA_SEEN", true) stats.set_bool(MPX .. "LOW_FLOW_CS_FUN_SEEN", true) stats.set_bool(MPX .. "LOW_FLOW_CS_PHO_SEEN", true) stats.set_bool(MPX .. "LOW_FLOW_CS_FIN_SEEN", true) stats.set_bool(MPX .. "LOW_BEN_INTRO_CS_SEEN", true) stats.set_int(MPX .. "LOWRIDER_FLOW_COMPLETE", 4) stats.set_int(MPX .. "LOW_FLOW_CURRENT_PROG", 9) stats.set_int(MPX .. "LOW_FLOW_CURRENT_CALL", 9) stats.set_int(MPX .. "LOW_FLOW_CS_HELPTEXT", 66) end) 
ExterminatorsID5:add_action("Skip Yatch Misions", function() stats.set_int(MPX .. "YACHT_MISSION_PROG", 0) stats.set_int(MPX .. "YACHT_MISSION_FLOW", 21845) stats.set_int(MPX .. "CASINO_DECORATION_GIFT_1", -1) end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsID1 = ExterminatorsID:add_submenu("🚫 ExterminatorsID Team")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ExterminatorsID1:add_action("---Kiddion---", function() end)

ExterminatorsID1:add_action("---ExterminatorsID---", function() end)

ExterminatorsID1:add_action("---Jawa Ireng---", function() end)

ExterminatorsID1:add_action("---Mr.99---", function() end)

ExterminatorsID1:add_action("---Sobing---", function() end)

ExterminatorsID1:add_action("---ade adrian---", function() end)

ExterminatorsID1:add_action("---GTA Indonesia---", function() end)

ExterminatorsID1:add_action("Gabung ke Discord Untuk Informasi", function() end)

ExterminatorsID1:add_action("https://discord.gg/6kgqseu4nw", function() end)

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
														

	ExterminatorsID10 = ExterminatorsID9:add_submenu("Get Crates")

	ExterminatorsID10:add_action("1-10 per Press", function() for i = 12, 16 do stats.set_bool_masked(MPX .. "FIXERPSTAT_BOOL1", true, i, MPX) end end)
	
			GCv0 = false
		local function GCv1()
		while GCv0 == true do for i = 12, 16 do stats.set_bool_masked(MPX .. "FIXERPSTAT_BOOL1", true, i, MPX) end end end
	ExterminatorsID10:add_toggle("Crates Loop", function() return GCv0 end, function() GCv0 = not GCv0 GCv1(GCv0) end)
	
			GCv2 = 1
	ExterminatorsID10:add_int_range("Instant Buy", 1, 1, 111, function() return GCv2 end, 
	...
	ExterminatorsID10:add_action("", function() end)
	
	ExterminatorsID10N = ExterminatorsID10:add_submenu("Read Me")
	
	ExterminatorsID10N:add_action("                       Crates Loop:", function() end) 
	ExterminatorsID10N:add_action("                	 To turn off the loop,", function() end) 
	ExterminatorsID10N:add_action("     close the menu via «Menu Settings»", function() end) 
	ExterminatorsID10N:add_action("", function() end) 
	ExterminatorsID10N:add_action("                       Instant Buy:", function() end) 
	ExterminatorsID10N:add_action("       Start the buy mission first, select", function() end) 
	ExterminatorsID10N:add_action("      the number of crates and activate", function() end) 

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	

ExterminatorsID8 = ExterminatorsID7:add_submenu("WareHouse Data Editor")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

ExterminatorsID8:add_action("--------------Warehouse Profile Editor--------------", function() end)
ExterminatorsID8:add_int_range("Change Lifetime Sales", 1, 0, 10000, function()
PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsID8:add_int_range("Change Lifetime Earnings Made", 200000.0, 0, 10000000, function()
PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		MPX = "MP0_"
	else
...
ExterminatorsID7N = ExterminatorsID7:add_submenu("ReadMe")

ExterminatorsID7N:add_action("     Ceo Crates Method       ", function() end)
ExterminatorsID7N:add_action("   First Enter Your Warehouse   ", function() end)
ExterminatorsID7N:add_action("Next Start Ultimate Money Manager       ", function() end)
ExterminatorsID7N:add_action("     Finally Active The Auto Sell Afk       ", function() end)
ExterminatorsID7N:add_action("", function() end)
ExterminatorsID7N:add_action("https://discord.gg/6kgqseu4nw", function() end)
